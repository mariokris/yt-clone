    ...
    <ScrollView style={styles.container}>
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.growingContent}>
          ...
          exploitive, destructive consumerism. We can create everything we need
          to thrive: food, medicine, building materials and fuel. We can create
          lasting legacies that produce abundance beyond our years. This
          prepares us for the biggest challenges we’ll face, whether drought,
          flood, famine or fire. This means local resilience in the face of
          fragile supply chains. Sowing abundance together, …we naturally foster
          community, …and delicious, nutritious beauty. …as we have for
          thousands of years, …it’s in our blood, it’s who we are. Many are
          anxious and depressed because they are disconnected from the divine
          design. This is the best way most of us can love ourselves and our
          communities. With plenty of fresh air, exercise, and sunshine, …we
          make ourselves maximally alive, healthy and strong. What’s more
          important than the health of us and our loved ones? It can be as
          simple and easy as feeding the bunnies and watering the flowers. Let’s
          plant paradise everywhere.
        </Text>
      </View>
    </ScrollView>
  );
